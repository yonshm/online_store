                    ...
                    <form action="{{ route('discounts.update', $discount->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control" required>
                                <option value="global" {{ $discount->type === 'all' ? 'selected' : '' }}>For all products</option>
                                <option value="product" {{ $discount->type === 'product' ? 'selected' : '' }}>For specific product</option>
                                <option value="category" {{ $discount->type === 'category' ? 'selected' : '' }}>For specific category</option>
                            </select>
                        </div>
